<template>
    <div class="container mx-auto max-w-screen-lg p-10">
        ...
        <p>Select the 'Format' (Words, Random, or UUID), and click the arrow on the right side of the selected option.</p>
        <p>Give the new alias an optional 'Description' and optional 'From name'.  Select one or more 'Recipient(s)', and choose the 'Domain'.</p>
        <p>Click the 'Create and copy to clipboard' button to add the alias to your account.</p>

        <h2>Aliases: What is a Catch-all Alias?</h2>
        <p>A 'Catch-all Alias' offers a way to use one address to receive mail for virtually infinite aliases.  If access to the Internet is not available and an alias is required, remember the Catch-all suffix and add an on-the-fly prefix to create a valid email alias.</p>
        <p>Note: One 'Catch-all Alias' is available per MailX account.</p>
        <p>To create a 'Catch-all Alias', navigate to the 'Aliases' page, and select the option from the 'New Alias' button's dropdown selector.</p>
        ...
        <p>Click the 'Create and copy to clipboard' button to add the alias to your account.</p>
        <p>To make use of the 'Catch-all Alias', add a prefix to your alias.  For example, use 'dentist' plus your 'Catch-all Alias' address for an instant alias: dentist+remember_this@domain</p>
        ...
        <p>In your preferred mail client or webmail system, send your message to this email address.</p>
