<template>
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-900">
        ...
        <form class="w-full max-w-sm bg-white dark:bg-neutral-800 px-8 pt-6 pb-8 mb-4" @submit.prevent="initiatePasswordReset">
            <div v-if="!apiSuccess">
                <p class="text-gray-500 dark:text-gray-300 mb-8">Please enter your registered email address. You will be sent instructions on how to reset your password.</p>
                <div class="mb-4">
            ...
            <div v-if="apiSuccess">
                <p class="text-gray-500 dark:text-gray-300">If an account with the specified email address exists we will send an email with further instructions on how to reset your password.</p>
            </div>
        </form>
