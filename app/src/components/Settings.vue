<template>
    <div class="card-container">
        ...
        <div class="card-primary">
            ...
            <h4>Log Issues</h4>
            <p>
                Log your email delivery (bounce) and forwarding issues. When enabled, these logs are recorded and stored for 7 days. You can view logged issues in the <router-link to="/logs">Logs</router-link> section.
            </p>
            <div class="mb-8">
